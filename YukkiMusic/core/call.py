    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**تماس فعالی یافت نشد**\n\nلطفا یک تماس ایجاد کنید ا اگر درحال اجرا هست ربات را ریستارت کنید "
                )

        except AlreadyJoinedError:
            raise AssistantErr(
                "**دستیار هم‌اکنون در حال گفتگوی صوتی است **\n\nسیستم ربات موسیقی تشخیص داد که دستیار هم‌اکنون در حال گفتگوی صوتی است. اگر مشکل ادامه پیدا کرد، ویدئوچت را دوباره راه‌اندازی کنید و دوباره تلاش کنید."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**مشکل سرور تلگرامی**\n\nلطفا ربات را بیستارت کنید."
            )
