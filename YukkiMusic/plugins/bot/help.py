...
@app.on_message(command("HELP_COMMAND",prefixes=["", "/"]) & filters.private & ~BANNED_USERS)
...
@app.on_message(command("HELP_COMMAND",prefixes=["", "/"]) & filters.group & ~BANNED_USERS)
@LanguageStart
    ...
    if mod_match:
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(text="🔄 بسته", callback_data="close"),
                ],
            ]
        )
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="↪️ برگشت", callback_data=f"help_prev({page_n},{int(close)})"
                    ),
                    InlineKeyboardButton(text="🔄 بسته", callback_data="close"),
                ]
            ]
