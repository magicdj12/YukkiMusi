...
@app.on_message(command("PLAYLIST_COMMAND",prefixes=["", "/"]) & ~BANNED_USERS)
@language
...
@app.on_message(command("DELETE_PLAYLIST_COMMAND",prefixes=["", "/"]) & filters.group & ~BANNED_USERS)
@language
...
@app.on_message(command("DELETE_PLAYLIST_COMMAND",prefixes=["", "/"]) & filters.private & ~BANNED_USERS)
@language
...
@app.on_message(command("PLAY_PLAYLIST_COMMAND",prefixes=["", "/"]) & ~BANNED_USERS & filters.group)
@languageCB
