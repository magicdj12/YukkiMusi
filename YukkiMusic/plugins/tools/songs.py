...
@app.on_message(command("SONG_COMMAND",prefixes=["", "/"]) & filters.group & ~BANNED_USERS)
@language
...
@app.on_message(command("SONG_COMMAND",prefixes=["", "/"]) & filters.private & ~BANNED_USERS)
@language
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    try:
        ...
        await CallbackQuery.answer("درحال دانلود...")
