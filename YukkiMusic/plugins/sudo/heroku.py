...
@app.on_message(command("GETLOG_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("GETVAR_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("DELVAR_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("SETVAR_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("USAGE_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("UPDATE_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
