...
async def blacklist_chat_func(client, message: Message, _):
    ...
    if blacklisted:
        ...
        await message.reply_text("یک مشکلی راخ داده است.")
    try:
...
async def white_funciton(client, message: Message, _):
    ...
    await message.reply_text("یک مشکلی رخ داده هست")


@app.on_message(command("BLACKLISTEDCHAT_COMMAND",prefixes=["", "/"]) & ~BANNED_USERS)
@language
