...
@app.on_message(command("AUTHORIZE_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("UNAUTHORIZE_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("AUTHORIZED_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
