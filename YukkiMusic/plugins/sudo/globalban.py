...
@app.on_message(command("GBAN_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("UNGBAN_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("GBANNED_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
