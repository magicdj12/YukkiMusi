...
@app.on_message(command("BLOCK_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("UNBLOCK_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
...
@app.on_message(command("BLOCKED_COMMAND",prefixes=["", "/"]) & SUDOERS)
@language
